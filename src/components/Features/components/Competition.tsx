      ...
      <div className="w-full flex flex-row-reverse justify-between items-center mt-10">
        ...
        <div className="flex flex-col">
          ...
          <p className="text-lg text-light-gray w-2/3">
            ...
            بیرون بکشید, اون پولی که جمع میکنید امتیاز شمارو مشخص میکنه و در نهایت جوایز با ارز تتر به کیف پولتان واریز می شوند
          </p>
          <br></br>
          <p>
            زمان ارائه: پنجشنبه ۹ اسفند ساعت ۱۸:۰۰ - ۱۴:۰۰
          </p>
        </div>
      </div>
